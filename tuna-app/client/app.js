...
app.controller('appController', function($scope, appFactory){
	...
	$scope.queryAllTuna = function(){
		...
		appFactory.queryAllTuna($scope.search, function(data){
			var array = [];
...
app.factory('appFactory', function($http){
    ...
    factory.queryAllTuna = function(data, callback){

		var search_condition = data.startkey + "-" + data.endkey;
		
    	$http.get('/get_all_tuna/'+search_condition).success(function(output){
			callback(output)
		});
	}
