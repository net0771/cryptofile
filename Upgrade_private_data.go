...
func (t *SimpleChaincode) initMarble(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	//  0-name  1-color  2-size  3-owner  4-price  5-status
	// "asdf",  "blue",  "35",   "bob",   "99",	   "stock"
	if len(args) != 6 {
	...
	// ==== Save marble private details ====
	objectType = "marbleStatus"
	marbleStatus := &marbleStatusPDC{objectType, marbleName, status}
...
// ===============================================
// checkStatus - check a marble's status from chaincode state
// ===============================================
